...
wind_speed_map = rxr.open_rasterio("data/processed_geotiffs_west_basin/processed_wind_speed.tif").sel(band=1)
...
# Plot Temperature
wind_speed_plot = wind_speed_map.plot(ax=axes[0], cmap="Dark2", add_colorbar=True)
axes[0].set_title("Processed Wind Speed (WS2M)")
