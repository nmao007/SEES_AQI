...
precipitation_map = rxr.open_rasterio("data/processed_geotiffs_west_basin/processed_precipitation.tif").sel(band=1)
...
# Plot Temperature
precipitation_plot = precipitation_map.plot(ax=axes[0], cmap="Dark2", add_colorbar=True)
axes[0].set_title("Processed Precipitation (Percip)")
