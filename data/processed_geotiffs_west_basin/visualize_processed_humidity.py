...
humidity_map = rxr.open_rasterio("data/processed_geotiffs_west_basin/processed_humidity.tif").sel(band=1)
...
# Plot Temperature
humidity_plot = humidity_map.plot(ax=axes[0], cmap="Dark2", add_colorbar=True)
axes[0].set_title("Processed Temperature (T2M)")
