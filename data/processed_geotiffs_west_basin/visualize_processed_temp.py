...
temp_map = rxr.open_rasterio("data/processed_geotiffs_west_basin/processed_temp.tif").sel(band=1)
...
# Plot Temperature
temp_plot = temp_map.plot(ax=axes[0], cmap="Dark2", add_colorbar=True)
