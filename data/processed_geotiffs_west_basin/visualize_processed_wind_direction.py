...
wind_direction_map = rxr.open_rasterio("data/processed_geotiffs_west_basin/processed_wind_direction.tif").sel(band=1)
...
# Plot Temperature
wind_direction_plot = wind_direction_map.plot(ax=axes[0], cmap="Dark2", add_colorbar=True)
axes[0].set_title("Processed Wind Direction (WD2M)")
