...
WIND_SPEED_2M_CSV = os.path.join(RAW_DATA_DIR, "FILL_IN_WIND_SPEED_CSV_NAME.csv")
WIND_DIR_2M_CSV   = os.path.join(RAW_DATA_DIR, "FILL_IN_WIND_DIRECTION_CSV_NAME.csv")
WIND_SPEED_10M_CSV = os.path.join(RAW_DATA_DIR, "FILL_IN_WIND_SPEED_CSV_NAME.csv")
WIND_DIR_10M_CSV   = os.path.join(RAW_DATA_DIR, "FILL_IN_WIND_DIRECTION_CSV_NAME.csv")
